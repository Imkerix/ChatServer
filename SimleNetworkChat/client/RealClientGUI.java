...
//						for(int i = 0; i<20; i++){
//							rp.addRoomPanel(new Object[]{"Ursula","Clementine","Simselbär","Fuchs","Gurkenschäler"},"Some badass Room",false);
//						}
						// no need to set arp preferedsize here, because it was determinated in AllRoomPanel this or the other way around
	...
	//// The part where you send messages //// 	/**Should be gained from active room*/
				...
				// Get Live into it
					...
					tglbtnPrivate.addActionListener(new ActionListener() 
					{
						public void actionPerformed(ActionEvent e) 
						{
							tglbtnBroadcast.setSelected(false);
							tglbtnRoom.setSelected(false);
							lblWhereTo.setText(tglbtnPrivate.getText()+endMessage);
